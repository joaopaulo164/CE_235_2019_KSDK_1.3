...
C_SRCS += \
C:/platform/hal/src/uart/fsl_uart_hal.c 

OBJS += \
./platform/uart/hal/fsl_uart_hal.o 

C_DEPS += \
./platform/uart/hal/fsl_uart_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/uart/hal/fsl_uart_hal.o: C:/platform/hal/src/uart/fsl_uart_hal.c
	@echo 'Building file: $<'
