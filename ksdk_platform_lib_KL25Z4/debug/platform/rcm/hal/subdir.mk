...
C_SRCS += \
C:/platform/hal/src/rcm/fsl_rcm_hal.c 

OBJS += \
./platform/rcm/hal/fsl_rcm_hal.o 

C_DEPS += \
./platform/rcm/hal/fsl_rcm_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/rcm/hal/fsl_rcm_hal.o: C:/platform/hal/src/rcm/fsl_rcm_hal.c
	@echo 'Building file: $<'
