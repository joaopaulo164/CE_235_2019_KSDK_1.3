...
C_SRCS += \
C:/platform/hal/src/tpm/fsl_tpm_hal.c 

OBJS += \
./platform/tpm/hal/fsl_tpm_hal.o 

C_DEPS += \
./platform/tpm/hal/fsl_tpm_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/tpm/hal/fsl_tpm_hal.o: C:/platform/hal/src/tpm/fsl_tpm_hal.c
	@echo 'Building file: $<'
