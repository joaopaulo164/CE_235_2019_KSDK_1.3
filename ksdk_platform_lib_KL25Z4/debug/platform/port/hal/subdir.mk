...
C_SRCS += \
C:/platform/hal/src/port/fsl_port_hal.c 

OBJS += \
./platform/port/hal/fsl_port_hal.o 

C_DEPS += \
./platform/port/hal/fsl_port_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/port/hal/fsl_port_hal.o: C:/platform/hal/src/port/fsl_port_hal.c
	@echo 'Building file: $<'
