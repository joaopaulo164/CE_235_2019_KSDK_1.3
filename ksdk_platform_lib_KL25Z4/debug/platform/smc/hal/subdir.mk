...
C_SRCS += \
C:/platform/hal/src/smc/fsl_smc_hal.c 

OBJS += \
./platform/smc/hal/fsl_smc_hal.o 

C_DEPS += \
./platform/smc/hal/fsl_smc_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/smc/hal/fsl_smc_hal.o: C:/platform/hal/src/smc/fsl_smc_hal.c
	@echo 'Building file: $<'
