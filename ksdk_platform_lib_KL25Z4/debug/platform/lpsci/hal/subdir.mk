...
C_SRCS += \
C:/platform/hal/src/lpsci/fsl_lpsci_hal.c 

OBJS += \
./platform/lpsci/hal/fsl_lpsci_hal.o 

C_DEPS += \
./platform/lpsci/hal/fsl_lpsci_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/lpsci/hal/fsl_lpsci_hal.o: C:/platform/hal/src/lpsci/fsl_lpsci_hal.c
	@echo 'Building file: $<'
