...
C_SRCS += \
C:/platform/hal/src/spi/fsl_spi_hal.c 

OBJS += \
./platform/spi/hal/fsl_spi_hal.o 

C_DEPS += \
./platform/spi/hal/fsl_spi_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/spi/hal/fsl_spi_hal.o: C:/platform/hal/src/spi/fsl_spi_hal.c
	@echo 'Building file: $<'
