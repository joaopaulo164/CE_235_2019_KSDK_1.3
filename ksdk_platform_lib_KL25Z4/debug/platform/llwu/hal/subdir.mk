...
C_SRCS += \
C:/platform/hal/src/llwu/fsl_llwu_hal.c 

OBJS += \
./platform/llwu/hal/fsl_llwu_hal.o 

C_DEPS += \
./platform/llwu/hal/fsl_llwu_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/llwu/hal/fsl_llwu_hal.o: C:/platform/hal/src/llwu/fsl_llwu_hal.c
	@echo 'Building file: $<'
